"""Tests for workers.stuck_detector — stuck agent pattern detection."""
...
from workers.models import ActionType, StepData
from workers.stuck_detector import StuckDetector, StuckSignal
