"""
backend/api/main.py — FastAPI cloud API for the ComputerUse service.
...
# (Replace with a real database via backend/db.py in production)
# ---------------------------------------------------------------------------
...
def verify_api_key(x_api_key: str = Header(..., alias="X-API-Key")) -> str:
    ...
    # TODO: validate against the real key store (backend/db.py).
...
async def create_task(
    ...
    #   from backend.tasks import run_task_async
    #   run_task_async.delay(task_id, body.model_dump(), api_key)
